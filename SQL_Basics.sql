...
/*
Order results with ORDER BY with ascending order. Add DESC for descending order.
*/
SELECT *
FROM demo_orders
...
IN
This allows you to perform operations similar to using WHERE and =, but for more
than one condition.
...
/*Recap
Commands
You have already learned a lot about writing code in SQL! Let's take a moment to
recap all that we have covered before moving on:
...
the key words does matter! Using what you know so far, you will want to write
your statements as: */
...
this way (col1, col2, col3, col4, col5) within a table called table1, this query
would run just fine.*/
